...
/// <summary>The 34-byte header at the start of every Aladdin Paint file (2-byte resolution + 32-byte palette).</summary>
[GenerateSerializer]
internal readonly partial record struct AladdinPaintHeader(
  ...
  public static AladdinPaintHeader FromPalette(short resolution, short[] palette) => new(
    resolution,
  ...
  public static HeaderFieldDescriptor[] GetFieldMap()
    => HeaderFieldMapper.GetFieldMap<AladdinPaintHeader>();
}
