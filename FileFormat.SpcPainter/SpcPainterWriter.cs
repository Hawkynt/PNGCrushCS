...
/// <summary>Assembles SPC Painter file bytes from an in-memory representation.</summary>
public static class SpcPainterWriter {
  ...
  public static byte[] ToBytes(SpcPainterFile file) {
