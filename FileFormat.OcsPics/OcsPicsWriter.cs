...
/// <summary>Assembles OCS Pics file bytes from an in-memory representation.</summary>
public static class OcsPicsWriter {
  ...
  public static byte[] ToBytes(OcsPicsFile file) {
