...
public sealed class PngFilterSelector(
  ...
  private PngFilterType _lastUsedFilter = PngFilterType.None;

  // For stickiness optimization
  private PngFilterType _stickyFilter = PngFilterType.None;
  ...
  public PngFilterType SelectFilterForScanline(ReadOnlySpan<byte> scanline, ReadOnlySpan<byte> previousScanline) {
  ...
  private PngFilterType SelectDynamicFilter(ReadOnlySpan<byte> scanline, ReadOnlySpan<byte> previousScanline) {
    ...
    try {
      ...
      foreach (var filterType in FilterTools.AllPngFilterTypes) {
  ...
  private void _UpdateStickiness(ReadOnlySpan<int> filterSums, PngFilterType winner) {
  ...
  private static PngFilterType SelectMinFilter(ReadOnlySpan<int> filterSums) {
    var bestFilter = PngFilterType.None;
