...
/// <summary>
/// One of ISO/IEC 14496-2 Annex B's variable-length code tables, held as written and read by lookup.
/// </summary>
/// <remarks>
/// The codes are given as the strings the standard prints them as — <c>"0000 0101 11"</c> — rather
/// than as a pair of numbers, so that a table can be read straight across from the page it was
...
/// </remarks>
internal sealed class Mpeg4VlcTable {
  ...
  internal Mpeg4VlcTable(string name, params (string Code, int Value)[] entries) {
    this._name = name;
