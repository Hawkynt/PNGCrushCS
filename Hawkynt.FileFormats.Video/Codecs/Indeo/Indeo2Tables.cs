...
/// <summary>
/// Indeo 2's two constant tables: the one Huffman code table every stream is coded with, and the four
/// delta tables a frame picks one of for luminance and one of for chrominance.
/// </summary>
/// <remarks>
/// Neither table is ever transmitted. A frame states which of the four delta tables its two planes use
/// and nothing more, so the numbers themselves are part of the codec and not part of the file — which
/// is why they are copied here exactly as the reference decoder holds them rather than derived from
/// anything. See <c>THIRD-PARTY-NOTICE.FFmpeg.txt</c> beside this file for where they come from.
/// <para/>
/// The Huffman table is given as a symbol and a code length per entry, in the order the codes are
/// assigned: the codes themselves are the canonical ones for those lengths, built once in
/// <see cref="Indeo2CodeTable"/>. The delta tables are read two bytes at a time, a code addressing a
/// pair; each byte is a sample value on the first line of a frame and a delta biased by 128 on every
/// line after it.
/// </remarks>
internal static class Indeo2Tables {

  /// <summary>One Huffman table entry: the symbol it stands for and how many bits its code is.</summary>
  /// <remarks>
  /// Symbols run 0x01..0x7F and 0x81..0x90 — the first are indices into a delta table, the second are
  /// run lengths. 0x00 and 0x80 are not codes a stream may carry, and a decoder that reads one has
  /// lost synchronisation rather than found a special case.
  /// </remarks>
  internal readonly record struct CodeEntry(byte Symbol, byte Length);

  /// <summary>The number of Huffman codes the table defines.</summary>
  internal const int CODE_COUNT = 143;

  /// <summary>The smallest symbol that means a run rather than a delta-table index.</summary>
  internal const int FIRST_RUN_SYMBOL = 0x80;

  internal static readonly CodeEntry[] Codes = [
    new(0x01,  3), new(0x02,  3), new(0x80,  3), new(0x03,  3), new(0x04,  5),
    new(0x81,  5), new(0x05,  5), new(0x06,  5), new(0x82,  5), new(0x83,  5),
    new(0x07,  5), new(0x08,  5), new(0x84,  6), new(0x09,  6), new(0x0A,  6),
    new(0x0B,  6), new(0x0C,  6), new(0x0D,  6), new(0x0E,  6), new(0x85,  6),
    new(0x0F,  8), new(0x10,  8), new(0x86,  8), new(0x87,  8), new(0x11,  8),
    new(0x12,  8), new(0x13,  8), new(0x14,  8), new(0x88,  8), new(0x15,  8),
    new(0x16,  8), new(0x89,  8), new(0x17,  8), new(0x18,  8), new(0x8A,  8),
    new(0x19,  8), new(0x1A,  9), new(0x8B,  9), new(0x1B,  9), new(0x1C,  9),
    new(0x8C,  9), new(0x1D,  9), new(0x1E,  9), new(0x8D,  9), new(0x1F,  9),
    new(0x20,  9), new(0x8E,  9), new(0x21,  9), new(0x22,  9), new(0x8F,  9),
    new(0x23,  9), new(0x24,  9), new(0x25, 10), new(0x26, 10), new(0x27, 10),
    new(0x28, 10), new(0x29, 10), new(0x2A, 10), new(0x2B, 10), new(0x2C, 10),
    new(0x2D, 10), new(0x2E, 10), new(0x2F, 10), new(0x30, 10), new(0x31, 10),
    new(0x32, 10), new(0x33, 10), new(0x34, 10), new(0x35, 13), new(0x36, 13),
    new(0x37, 13), new(0x38, 13), new(0x39, 13), new(0x3A, 13), new(0x3B, 13),
    new(0x3C, 13), new(0x3D, 13), new(0x3E, 13), new(0x3F, 13), new(0x40, 13),
    new(0x41, 13), new(0x42, 13), new(0x43, 13), new(0x44, 13), new(0x45, 13),
    new(0x46, 13), new(0x47, 13), new(0x48, 13), new(0x49, 13), new(0x4A, 13),
    new(0x4B, 13), new(0x4C, 13), new(0x4D, 13), new(0x4E, 13), new(0x4F, 13),
    new(0x50, 13), new(0x51, 13), new(0x52, 13), new(0x53, 13), new(0x54, 13),
    new(0x55, 13), new(0x56, 13), new(0x57, 13), new(0x58, 13), new(0x59, 13),
    new(0x5A, 13), new(0x5B, 13), new(0x5C, 13), new(0x5D, 13), new(0x5E, 13),
    new(0x5F, 13), new(0x60, 13), new(0x61, 13), new(0x62, 13), new(0x63, 13),
    new(0x64, 13), new(0x65, 13), new(0x66, 13), new(0x67, 13), new(0x68, 13),
    new(0x69, 13), new(0x6A, 13), new(0x6B, 13), new(0x6C, 13), new(0x6D, 13),
    new(0x6E, 13), new(0x6F, 13), new(0x70, 13), new(0x71, 13), new(0x72, 13),
    new(0x73, 13), new(0x74, 13), new(0x75, 14), new(0x76, 14), new(0x77, 14),
    new(0x78, 14), new(0x79, 14), new(0x7A, 14), new(0x7B, 14), new(0x7C, 14),
    new(0x7D, 14), new(0x7E, 14), new(0x7F, 14),
  ];

  /// <summary>The four delta tables, one of which each plane of each frame is coded against.</summary>
  internal static readonly byte[][] Deltas = [
    [
