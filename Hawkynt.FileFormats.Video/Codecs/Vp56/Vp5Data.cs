...
/// <summary>Fixed VP5 probability-update and context-remapping tables.</summary>
/// <remarks>
/// Adapted from FFmpeg's <c>libavcodec/vp5data.h</c>, Copyright (C) 2006 Aurelien Jacobs,
/// licensed LGPL-2.1-or-later. The target assembly is LGPL-3.0-or-later. These values are fixed
/// interoperability data used to reproduce VP5's entropy models.
/// </remarks>
internal static class Vp5Data {
  ...
  /// <summary>Linear maps used to derive the 36 DC-context probabilities from the transmitted models.</summary>
  internal static readonly (short Scale, short Offset)[,] DcContextLinear = {
    {
  ...
  /// <summary>Linear maps for VP5's AC context probabilities, indexed code-type/group/node/context.</summary>
  internal static readonly (short Scale, short Offset)[,,,] AcContextLinear = {
    {
      {
  ...
  internal static readonly byte[] CoordinateDivisor = [2, 2, 2, 2, 4, 4];

  /// <summary>Standard scan-position to natural 8x8 coefficient position mapping.</summary>
