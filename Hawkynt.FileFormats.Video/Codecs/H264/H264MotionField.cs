...
internal sealed class H264MotionField {
  internal H264MotionField(int widthInBlocks, int heightInBlocks) {
    ...
    this.RefIdx0 = new sbyte[count];
    this.RefIdx0.AsSpan().Fill(-1);
    this.RefSerial0 = new long[count];
    this.MvX1 = new short[count];
    this.MvY1 = new short[count];
    this.RefIdx1 = new sbyte[count];
    this.RefIdx1.AsSpan().Fill(-1);
  ...
  internal bool TryGet(int blockX, int blockY, out H264StoredMotion motion) {
    ...
    motion = new(
      this.MvX0[at], this.MvY0[at], this.RefIdx0[at], this.RefSerial0[at],
      this.MvX1[at], this.MvY1[at], this.RefIdx1[at], this.RefSerial1[at]);
    return true;
  }
}
...
internal readonly record struct H264StoredMotion(
  ...
  int RefIdx1,
  long RefSerial1) {
  internal bool HasList0 => this.RefIdx0 >= 0;
  internal bool HasList1 => this.RefIdx1 >= 0;
}
