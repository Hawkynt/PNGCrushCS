...
public sealed class CineFormVideoEncoder : IVideoCodecEncoder<CineFormVideoEncoder> {
  ...
  /// <summary>Creates a CineForm writer for one of its supported progressive layouts.</summary>
  ...
  private byte[] _EncodeBayer(RawImage frame, ushort frameNumber) {
    ...
    foreach (var plane in planes)
      _PadRows(plane, componentWidth, componentHeight, codedComponentHeight);
