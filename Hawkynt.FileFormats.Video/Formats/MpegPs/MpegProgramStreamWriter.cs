  ...
  private MpegProgramStreamWriter(IReadOnlyList<MediaStreamInfo> streams, VideoMetadata metadata) {
    ...
    for (var i = 0; i < streams.Count; ++i) {
      ...
      if (stream.Kind == MediaStreamKind.Video) {
        ...
        this._addresses[i] = new((byte)(0xE0 + video++), null, 0);
        ...
        this._addresses[i] = new((byte)(0xC0 + audio++), null, 0);
        ...
        this._addresses[i] = new(MpegPsScanner.PRIVATE_STREAM_1, (byte)(0x80 + ac3++), 4);
        ...
        this._addresses[i] = new(MpegPsScanner.PRIVATE_STREAM_1, (byte)(0x88 + dts++), 4);
        ...
        this._addresses[i] = new(MpegPsScanner.PRIVATE_STREAM_1, (byte)(0x20 + subpicture++), 1);
      } else
