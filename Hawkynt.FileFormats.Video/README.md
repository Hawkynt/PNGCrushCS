...
what [`VideoFormatRegistry.CreateEncoder`](https://github.com/Hawkynt/PNGCrushCS/blob/main/Hawkynt.FileFormats.Video/VideoFormatRegistry.cs) builds, 60 of them. The two
...
Microsoft's MPEG-4, ASUS V1 and V2, Apple Video, Apple Motion JPEG-B, H.261, H.263, H.265, MPEG-1 video, MPEG-2 video, MPEG-4 Part 2, On2 VP3, Hap, Apple ProRes, id RoQ — the row says so, because there is nothing else such an encoder
...
Every public and protected member of all 482 types, generated from the built assembly and its XML documentation, is in [REFERENCE.md](https://github.com/Hawkynt/PNGCrushCS/blob/main/Hawkynt.FileFormats.Video/REFERENCE.md).
