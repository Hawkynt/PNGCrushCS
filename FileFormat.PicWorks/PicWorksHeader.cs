...
/// <summary>The 34-byte header at the start of every PicWorks file (2-byte resolution + 32-byte palette).</summary>
[GenerateSerializer]
internal readonly partial record struct PicWorksHeader(
  ...
  public static PicWorksHeader FromPalette(short resolution, short[] palette) => new(
    resolution,
  ...
  public static HeaderFieldDescriptor[] GetFieldMap()
    => HeaderFieldMapper.GetFieldMap<PicWorksHeader>();
}
