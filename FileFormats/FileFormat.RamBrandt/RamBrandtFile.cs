...
public readonly record struct RamBrandtFile : IImageFormatReader<RamBrandtFile>, IImageToRawImage<RamBrandtFile>, IImageFromRawImage<RamBrandtFile>, IImageFormatWriter<RamBrandtFile> {
  ...
  static VideoMode[] IImageFormatMetadata<RamBrandtFile>.VideoModes => [new("Default", [(IntegerRange.Any, IntegerRange.Any)], [new IntegerRange(2, 4)])];
  ...
  /// <summary>Creates a Ram Brandt file from a platform-independent <see cref="RawImage"/>.</summary>
