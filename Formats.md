...
> does not write, and counts them. At the time of writing that is 62 of 847.
...
| SymbOS graphic          | .sgx                                                 | Tiled, four or sixteen colours   | Y      | —      | —         | R     | —   | —      | —         |
| SEUCK sprites           | .a                                                   | 127 C64 sprites as a sheet       | Y      | —      | —         | R     | —   | —      | —         |
| MINIPAINT               | .mg                                                  | VIC-20, two modes mixed per cell | Y      | —      | —         | R     | —   | —      | —         |
| PaintShop (compressed)  | .psc                                                 | Packed a scanline at a time      | Y      | —      | —         | R     | —   | —      | —         |
| Kompresor do Animatora  | .kpr                                                 | Animation as tiles and a map     | Y      | —      | —         | R     | —   | —      | —         |
| Trzmiel (compressed)    | .cpr                                                 | Koala packing, three layouts     | Y      | —      | —         | R     | —   | —      | —         |
| Grass' Slideshow        | .hpm                                                 | Packed Graphics 15, named palette | Y     | —      | —         | R     | —   | —      | —         |
| XL-Paint                | .xlp                                                 | Two fields packed down columns   | Y      | —      | —         | R     | —   | —      | —         |
| DelmPaint               | .del, .dph                                           | Falcon, packed in ST-screen blocks | Y    | —      | —         | R     | —   | —      | —         |
| D-GRAPH (compressed)    | .p3c                                                 | Two ST screens, lengths as text  | Y      | —      | —         | R     | —   | —      | —         |
| Champions' Interlace    | .cin, .cci                                           | Atari; rows alternate two fields | Y      | —      | —         | R     | —   | —      | —         |
| CharPad                 | .ctm                                                 | Characters, tiles and a map      | Y      | —      | —         | R     | —   | —      | —         |
| AMOS bank               | .abk                                                 | Amiga sprites, icons or a screen | Y      | —      | —         | R     | —   | —      | —         |
| Super Hires FLI Editor  | .shf                                                 | FLI with a sprite band at the left | Y    | —      | —         | R     | —   | —      | —         |
| Extend Super Hires      | .esh                                                 | Two hires frames, sprites, shared colours | Y | —   | —         | R     | —   | —      | —         |
| UIFLI-editor            | .uif                                                 | Two FLI frames, packed backwards | Y      | —      | —         | R     | —   | —      | —         |
| SHF-XL Edit             | .shx                                                 | FLI and sprites, two unlike forms | Y     | —      | —         | R     | —   | —      | —         |
| Advanced OCP Art Studio | .win (+ .pal)                                        | Amstrad mode 0 clipping          | Y      | —      | —         | R     | —   | —      | —         |
| Mode 5                  | .cm5 (+ .gfx)                                        | Mode 1 with a palette per row    | Y      | —      | —         | R     | —   | —      | —         |
...
| GED                     | .ged                                                 | Six colour changes per scanline  | Y      | —      | —         | R     | —   | —      | —         |
| PowerGraphics           | .pgr                                                 | A display program, not a picture | Y      | —      | —         | R     | —   | —      | —         |
| Graph2Font MCH          | .mch                                                 | Every cell its own character     | Y      | —      | —         | R     | —   | —      | —         |
| Graph2Font              | .g2f                                                 | Every register, every scanline   | Y      | —      | —         | R     | —   | —      | —         |
...
| Mapletown Network NL3   | .nl3                                                 | Printable characters only        | Y      | Y      | —         | R     | —   | —      | —         |
...
| Sun TAAC                | .vff, .taac, .suniff                                 | Sun TAAC/Visualization bitmap    | Y      | Y      | —         | —     | —   | R      | —         |
...
| Metric                                                    | Us    | RECOIL |
| ----------------------------------------------------------- | ----- | ------ |
| Total formats                                              | 681   | 552    |
| Modern/web/scientific formats (PNG, JPEG, WebP, AVIF, …)   | ~290  | 0      |
| Of RECOIL's 552 vintage formats, covered                   | 552   | 552    |

So on breadth we are level, and on everything outside the retro catalogue we are the only one of
So on breadth we are ahead, and on the retro catalogue we are now level: every one of RECOIL's
552 entries is read here, and every one of them was checked against RECOIL itself rather than
