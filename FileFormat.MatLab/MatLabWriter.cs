...
public static class MatLabWriter {
  ...
  public static byte[] ToBytes(MatLabFile file) {
    ...
    file.PixelData.AsSpan(0, Math.Min(pixelBytes, file.PixelData.Length)).CopyTo(result.AsSpan(MatLabFile.HeaderSize));
    return result;
  }
}
