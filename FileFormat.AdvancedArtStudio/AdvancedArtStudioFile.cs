...
public readonly record struct AdvancedArtStudioFile : IImageFormatReader<AdvancedArtStudioFile>, IImageToRawImage<AdvancedArtStudioFile>, IImageFormatWriter<AdvancedArtStudioFile> {
  ...
  /// <summary>The expected total file size in bytes (2 + 8000 + 1000 + 1000 + 16).</summary>
  ...
  /// <summary>Size of the trailing section (border, background, padding) in bytes.</summary>
  internal const int TrailingSize = 16;
