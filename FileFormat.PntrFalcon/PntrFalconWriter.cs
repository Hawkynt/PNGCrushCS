...
/// <summary>Assembles PntrFalcon screen dump bytes from pixel data.</summary>
public static class PntrFalconWriter {
  ...
  public static byte[] ToBytes(PntrFalconFile file) => Assemble(file.PixelData);
