...
/// <summary>Assembles Cloe Ray-Tracer image file bytes.</summary>
public static class CloeWriter {

  public static byte[] ToBytes(CloeFile file) {
    ArgumentNullException.ThrowIfNull(file);
    var pixelBytes = file.PixelData.Length;
    var fileSize = CloeFile.HeaderSize + pixelBytes;
