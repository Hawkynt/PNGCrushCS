...
/// <summary>Assembles Digi Spec file bytes from an in-memory representation.</summary>
public static class DigiSpecWriter {
  ...
  public static byte[] ToBytes(DigiSpecFile file) {
