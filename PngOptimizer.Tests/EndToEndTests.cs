...
public sealed class EndToEndTests {
  ...
  public async Task Gradient_RGB_ProducesValidPng() {
    ...
    Assert.That(result.ColorMode, Is.EqualTo(ColorMode.RGB));
    VerifyPngSignature(result.FileContents);
  }
  ...
  public async Task TwoColor_UsesPaletteMode() {
    ...
    Assert.That(result.ColorMode, Is.AnyOf(ColorMode.Palette, ColorMode.Grayscale));
    VerifyPngSignature(result.FileContents);
  }
  ...
  public async Task Grayscale_DetectedCorrectly() {
    ...
    Assert.That(result.ColorMode, Is.EqualTo(ColorMode.Grayscale));
    VerifyPngSignature(result.FileContents);
  }
  ...
  public async Task AutoColorModeDisabled_UsesRGBOrRGBA() {
    ...
    Assert.That(result.ColorMode, Is.AnyOf(ColorMode.RGB, ColorMode.RGBA));
  }
  ...
  public async Task SolidColor_PaletteTrimmed_SmallPLTE() {
    ...
    if (result.ColorMode == ColorMode.Palette) {
  ...
  public async Task AlphaImage_FewColors_UsesPalettePlusTRNS() {
    ...
    Assert.That(result.ColorMode, Is.EqualTo(ColorMode.Palette));
  ...
  public void SemiTransparentImage_RgbTrns_NotTried() {
    ...
    Assert.That(result.ColorMode, Is.Not.EqualTo(ColorMode.RGB).Or.EqualTo(ColorMode.RGBA));
  }
  ...
  public async Task GrayscaleWithBinaryAlpha_TriesGrayscalePlusTRNS() {
    ...
    using (bmp) {
      ...
      Assert.That(result.ColorMode, Is.EqualTo(ColorMode.Grayscale).Or.EqualTo(ColorMode.GrayscaleAlpha));
    }
  }
