...
public static class VividWriter {
  ...
  public static byte[] ToBytes(VividFile file) {
    ...
    file.PixelData.AsSpan(0, Math.Min(pixelBytes, file.PixelData.Length)).CopyTo(result.AsSpan(VividFile.HeaderSize));
    return result;
  }
}
