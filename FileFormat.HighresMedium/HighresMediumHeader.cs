...
internal readonly partial record struct HighresMediumHeader(
  ...
  /// <summary>Size of one frame: 32-byte palette + 32000 bytes planar data.</summary>
  ...
  public static HighresMediumHeader FromPalette(short[] palette) => new(
  ...
  public static HeaderFieldDescriptor[] GetFieldMap()
    => HeaderFieldMapper.GetFieldMap<HighresMediumHeader>();
}
