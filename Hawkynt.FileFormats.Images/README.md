...
Where it stands, against `djxl`, counted in pixels that differ out of the picture's own: a flat 64x64 two of 4,096, and a 64x64 gradient two, in colour four, a single dot four, a single block six, a sixteen-by-sixteen four of 256 — those are within a level or two everywhere and are as near exact as this decoder gets. Then a 64x64 plasma 51 of 4,096; a 128x96 80 of 12,288; a 96x96 138 of 9,216; a 100x100 with an alpha plane 151 of 10,000; a 128x96 156 and another 169 of 12,288; a 300x200 gradient in two groups 163 of 60,000; a 128x128 207 of 16,384; a 160x160 353 of 25,600; a 200x150 362 of 30,000; a 192x192 434 of 36,864; a 224x224 459 of 50,176; a 300x200 570 of 60,000; a 256x256 600 of 65,536; a 257x256 610 of 65,792; a 250x250 616 of 62,500; a 400x300 in four groups 1,102 of 120,000; a 640x480 in six 2,749 of 307,200; and a 1,024x768 in twelve 5,247 of 786,432 — under one percent everywhere and under a tenth of one percent at the top of that list. Every one of these was a decoder that lost the bitstream before any of this began. Close is still not what this package hands back, so all of them are still refused to callers.
