...
Every lossy file in the corpus decodes — 36 of them, from one group up to twelve. Against `djxl`, counted in pixels that differ out of the picture's own: a 16x16 one of 256; a flat 64x64 two of 4,096, a gradient two, a single dot two, a single block three, the gradient in colour four, a plasma eight; a 100x100 with an alpha plane nine of 10,000; a 96x96 16 of 9,216; a 128x96 18 of 12,288; a 128x128 26 of 16,384; a 160x160 40 of 25,600; a 200x150 plasma 49 of 30,000; a 192x192 55 of 36,864; a 300x200 gradient 59 of 60,000; a 224x224 72 of 50,176; a 200x256 73 of 51,200; a 250x250 86 of 62,500; a 256x256 88 of 65,536; a 400x300 in four groups 304 of 120,000. The worst single pixel is usually under ten now, where before this work most of these files could not be read at all. Close is still not what this package hands back, so all of them are still refused to callers.
