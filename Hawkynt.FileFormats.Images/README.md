...
The worst single pixel is usually under ten now, where before this work most of these files could not be read at all. Close is still not what this package hands back, so all of them are still refused to callers.
