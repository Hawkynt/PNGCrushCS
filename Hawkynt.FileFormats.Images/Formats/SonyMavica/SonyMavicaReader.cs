...
public static class SonyMavicaReader {
  ...
  public static SonyMavicaFile FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));

  public static SonyMavicaFile FromSpan(ReadOnlySpan<byte> data) {
    ...
    data.Slice(SonyMavicaFile.HeaderSize, pixelDataSize).CopyTo(pixelData.AsSpan(0));
