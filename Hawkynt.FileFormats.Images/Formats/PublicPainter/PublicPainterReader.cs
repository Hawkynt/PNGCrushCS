...
public static class PublicPainterReader {
  ...
  public static PublicPainterFile FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));
  ...
  public static PublicPainterFile FromSpan(ReadOnlySpan<byte> data) {
    ...
    var pixelData = PublicPainterCompressor.Decompress(
      data[PublicPainterFile.StreamOffset..], data[PublicPainterFile.EscapeOffset], PublicPainterFile.DecompressedSize);
