...
public static class WonderSwanTileReader {
  ...
  public static WonderSwanTileFile FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));

  public static WonderSwanTileFile FromSpan(ReadOnlySpan<byte> data) {
