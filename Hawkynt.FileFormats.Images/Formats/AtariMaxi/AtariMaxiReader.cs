...
public static class AtariMaxiReader {
  ...
  public static AtariMaxiFile FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));

  public static AtariMaxiFile FromSpan(ReadOnlySpan<byte> data) {
    ...
    data.Slice(0, AtariMaxiFile.ExpectedFileSize).CopyTo(pixelData);
