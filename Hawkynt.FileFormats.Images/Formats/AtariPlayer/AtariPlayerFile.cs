...
public readonly record struct AtariPlayerFile : IImageFormatReader<AtariPlayerFile>, IImageToRawImage<AtariPlayerFile>, IImageFromRawImage<AtariPlayerFile>, IImageFormatWriter<AtariPlayerFile> {
  ...
  static string IImageFormatMetadata<AtariPlayerFile>.PrimaryExtension => ".pmg";
  ...
  static VideoMode[] IImageFormatMetadata<AtariPlayerFile>.VideoModes => [
    new("Default", [(32, 256)], [2])
  ];
