...
/// <summary>In-memory representation of a Photo Studio picture.</summary>
/// <remarks>
...
public readonly record struct PhotoStudioFile
  ...
  static bool? IImageFormatMetadata<PhotoStudioFile>.MatchesSignature(ReadOnlySpan<byte> header)
    => header.Length >= Magic.Length && header[..Magic.Length].SequenceEqual(Magic) ? true : null;

  /// <summary>The bytes a file opens with.</summary>
  internal static ReadOnlySpan<byte> Magic => "FSPA"u8;
