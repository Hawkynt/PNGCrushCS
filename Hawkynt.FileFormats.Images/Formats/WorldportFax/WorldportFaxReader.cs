...
public static class WorldportFaxReader {
  ...
  public static WorldportFaxFile FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));

  public static WorldportFaxFile FromSpan(ReadOnlySpan<byte> data) {
    ...
    data.Slice(WorldportFaxFile.HeaderSize, pixelDataSize).CopyTo(pixelData.AsSpan(0));
