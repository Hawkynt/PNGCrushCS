...
/// <summary>In-memory representation of a Wiz Solitaire deck.</summary>
/// <remarks>
...
public readonly record struct WizSolitaireDeckFile
  ...
  static bool? IImageFormatMetadata<WizSolitaireDeckFile>.MatchesSignature(ReadOnlySpan<byte> header)
    => header.Length >= Magic.Length && header[..Magic.Length].SequenceEqual(Magic) ? true : null;

  /// <summary>The bytes a file opens with.</summary>
  internal static ReadOnlySpan<byte> Magic => "WizSolitaireDeck"u8;
