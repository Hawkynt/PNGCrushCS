...
public static class AtariGraphics11Reader {
  ...
  public static AtariGraphics11File FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));

  public static AtariGraphics11File FromSpan(ReadOnlySpan<byte> data) {
    ...
    data.Slice(0, AtariGraphics11File.FileSize).CopyTo(pixelData);
