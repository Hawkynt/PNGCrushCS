...
public readonly record struct MltFile
  : IImageFormatReader<MltFile>, IImageToRawImage<MltFile>,
    IImageFromRawImage<MltFile>, IImageFormatWriter<MltFile> {
  ...
  /// <summary>Encodes a picture as an Mlt screen, scaling it to 160x200 first.</summary>
  /// <remarks>
  ...
  /// </remarks>
  public static MltFile FromRawImage(RawImage image) {
