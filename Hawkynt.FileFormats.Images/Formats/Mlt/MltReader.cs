...
public static class MltReader {
  ...
  public static MltFile FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));

  public static MltFile FromSpan(ReadOnlySpan<byte> data) {
