...
public readonly record struct HinterGrundBildFile
  : IImageFormatReader<HinterGrundBildFile>, IImageToRawImage<HinterGrundBildFile>,
    IImageFromRawImage<HinterGrundBildFile>, IImageFormatWriter<HinterGrundBildFile> {
  ...
  /// <summary>Encodes a picture as a HinterGrundBild screen, scaling it to 160x200 first.</summary>
  /// <remarks>
  ...
  /// </remarks>
  public static HinterGrundBildFile FromRawImage(RawImage image) {
