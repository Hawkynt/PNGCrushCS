...
public static class Fli64Reader {
  ...
  public static Fli64File FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));

  public static Fli64File FromSpan(ReadOnlySpan<byte> data) {
