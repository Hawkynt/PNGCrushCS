...
public static class NokiaOperatorLogoReader {
  ...
  public static NokiaOperatorLogoFile FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));

  public static NokiaOperatorLogoFile FromSpan(ReadOnlySpan<byte> data) {
