...
public static class SegaGenTileReader {
  ...
  public static SegaGenTileFile FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));

  public static SegaGenTileFile FromSpan(ReadOnlySpan<byte> data) {
