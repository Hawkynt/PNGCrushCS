...
public static class MobileFaxReader {
  ...
  public static MobileFaxFile FromStream(Stream stream) => FromSpan(StreamBytes.ReadAll(stream));
  ...
  public static MobileFaxFile FromSpan(ReadOnlySpan<byte> data) {
    ...
    data.Slice(MobileFaxFile.HeaderSize, pixelDataSize).CopyTo(pixelData.AsSpan(0));
