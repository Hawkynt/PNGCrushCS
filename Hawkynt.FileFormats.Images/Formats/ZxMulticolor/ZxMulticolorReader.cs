...
public static class ZxMulticolorReader {
  ...
  public static ZxMulticolorFile FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));

  public static ZxMulticolorFile FromSpan(ReadOnlySpan<byte> data) {
