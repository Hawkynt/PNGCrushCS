...
public static class ZxBorderMulticolorReader {
  ...
  public static ZxBorderMulticolorFile FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));

  public static ZxBorderMulticolorFile FromSpan(ReadOnlySpan<byte> data) {
