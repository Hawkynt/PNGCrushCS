...
public static class VirtualBoyTileReader {
  ...
  public static VirtualBoyTileFile FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));

  public static VirtualBoyTileFile FromSpan(ReadOnlySpan<byte> data) {
