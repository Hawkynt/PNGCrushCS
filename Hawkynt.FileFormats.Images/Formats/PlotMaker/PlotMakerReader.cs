...
public static class PlotMakerReader {
  ...
  public static PlotMakerFile FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));

  public static PlotMakerFile FromSpan(ReadOnlySpan<byte> data) {
    ...
    data.Slice(PlotMakerFile.HeaderSize, expectedPixelBytes).CopyTo(pixelData.AsSpan(0));
