...
public static class PhotoChromeReader {
  ...
  public static PhotoChromeFile FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));

  public static PhotoChromeFile FromSpan(ReadOnlySpan<byte> data) {
