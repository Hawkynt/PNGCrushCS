...
public static class Enterprise128Reader {
  ...
  public static Enterprise128File FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));

  public static Enterprise128File FromSpan(ReadOnlySpan<byte> data) {
