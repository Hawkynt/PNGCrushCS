...
public static class NeoGeoPocketReader {
  ...
  public static NeoGeoPocketFile FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));

  public static NeoGeoPocketFile FromSpan(ReadOnlySpan<byte> data) {
