...
public static class StTrueColorReader {
  ...
  public static StTrueColorFile FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));

  public static StTrueColorFile FromSpan(ReadOnlySpan<byte> data) {
    ...
    data.Slice(0, StTrueColorFile.FileSize).CopyTo(pixelData.AsSpan(0));
