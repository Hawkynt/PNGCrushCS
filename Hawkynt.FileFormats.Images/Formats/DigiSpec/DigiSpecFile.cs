...
public readonly record struct DigiSpecFile : IImageFormatReader<DigiSpecFile>, IImageToRawImage<DigiSpecFile>, IImageFromRawImage<DigiSpecFile>, IImageFormatWriter<DigiSpecFile> {
  ...
  static string IImageFormatMetadata<DigiSpecFile>.PrimaryExtension => ".dgs";
  ...
  static VideoMode[] IImageFormatMetadata<DigiSpecFile>.VideoModes => [
  ...
  /// <summary>Creates a Digi Spec image from a <see cref="RawImage"/>, sampling it to the ST's 320x200 low-resolution screen.</summary>
  /// <remarks>
