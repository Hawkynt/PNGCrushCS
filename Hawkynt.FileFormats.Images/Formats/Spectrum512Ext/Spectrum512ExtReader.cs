...
public static class Spectrum512ExtReader {
  ...
  public static Spectrum512ExtFile FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));

  public static Spectrum512ExtFile FromSpan(ReadOnlySpan<byte> data) {
