...
public static class CiscoIpWriter {
  ...
  public static byte[] ToBytes(CiscoIpFile file) {
    ...
    file.PixelData.AsSpan(0, Math.Min(pixelBytes, file.PixelData.Length)).CopyTo(result.AsSpan(CiscoIpFile.HeaderSize));
    return result;
  }
}
