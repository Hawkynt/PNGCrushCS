...
public readonly record struct HardInterlaceFile
  : IImageFormatReader<HardInterlaceFile>, IImageToRawImage<HardInterlaceFile>,
    IImageFromRawImage<HardInterlaceFile>, IImageFormatWriter<HardInterlaceFile> {
  ...
  /// <summary>Encodes a picture as a Hard Interlace pair, scaling it to 320x200 first.</summary>
  /// <remarks>
