...
public readonly record struct TurboViewFile : IImageFormatReader<TurboViewFile>, IImageToRawImage<TurboViewFile>, IImageFromRawImage<TurboViewFile>, IImageFormatWriter<TurboViewFile> {
  ...
  /// <summary>Encodes a picture as a Turbo View picture, scaling it to 320x200 first.</summary>
  /// <remarks>
