...
public static class ZxArtStudioReader {
  ...
  public static ZxArtStudioFile FromStream(Stream stream) => FromBytes(StreamBytes.ReadAll(stream));

  public static ZxArtStudioFile FromSpan(ReadOnlySpan<byte> data) {
