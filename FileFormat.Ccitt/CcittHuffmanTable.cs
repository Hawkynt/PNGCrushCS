...
/// <summary>Static ITU-T T.4 Huffman code tables for white and black run lengths.</summary>
internal static class CcittHuffmanTable {

  /// <summary>White terminating codes for run lengths 0-63. Each entry is (code, bitLength).</summary>
  internal static readonly (int Code, int BitLength)[] WhiteTerminating = [
    (0b00110101, 8),   // 0
    (0b000111, 6),     // 1
    (0b0111, 4),       // 2
    (0b1000, 4),       // 3
  ...
  /// <summary>Black terminating codes for run lengths 0-63. Each entry is (code, bitLength).</summary>
  internal static readonly (int Code, int BitLength)[] BlackTerminating = [
    (0b0000110111, 10),  // 0
    (0b010, 3),          // 1
    (0b11, 2),           // 2
    (0b10, 2),           // 3
  ...
  /// <summary>White make-up codes for run lengths 64, 128, ..., 1728. Each entry is (code, bitLength).</summary>
  internal static readonly (int Code, int BitLength)[] WhiteMakeUp = [
    (0b11011, 5),       // 64
    (0b10010, 5),       // 128
    (0b010111, 6),      // 192
    (0b0110111, 7),     // 256
  ...
  /// <summary>Black make-up codes for run lengths 64, 128, ..., 1728. Each entry is (code, bitLength).</summary>
  internal static readonly (int Code, int BitLength)[] BlackMakeUp = [
    (0b0000001111, 10),   // 64
