...
/// <summary>Assembles FreeHand ST file bytes from an in-memory representation.</summary>
public static class FreeHandWriter {
  ...
  public static byte[] ToBytes(FreeHandFile file) {
