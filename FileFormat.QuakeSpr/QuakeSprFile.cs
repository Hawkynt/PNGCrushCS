...
public sealed class QuakeSprFile : IImageFileFormat<QuakeSprFile> {

  static string IImageFileFormat<QuakeSprFile>.PrimaryExtension => ".spr";
  static string[] IImageFileFormat<QuakeSprFile>.FileExtensions => [".spr"];
  static QuakeSprFile IImageFileFormat<QuakeSprFile>.FromFile(FileInfo file) => QuakeSprReader.FromFile(file);
  static QuakeSprFile IImageFileFormat<QuakeSprFile>.FromBytes(byte[] data) => QuakeSprReader.FromBytes(data);
  static QuakeSprFile IImageFileFormat<QuakeSprFile>.FromStream(Stream stream) => QuakeSprReader.FromStream(stream);
  static byte[] IImageFileFormat<QuakeSprFile>.ToBytes(QuakeSprFile file) => QuakeSprWriter.ToBytes(file);
  ...
  public int NumFrames { get; init; } = 1;
  ...
  public byte[] Palette { get; init; } = DefaultPalette;
