...
/// <summary>Reads IFF DPAN (DPaint animation info) files from bytes, streams, or file paths.</summary>
public static class IffDpanReader {
  ...
  public static IffDpanFile FromBytes(byte[] data) {
    ...
    var width = IffDpanFile.DefaultWidth;
    var height = IffDpanFile.DefaultHeight;
  ...
  private static void _TryParseBmhd(byte[] data, out int width, out int height) {
    width = IffDpanFile.DefaultWidth;
    height = IffDpanFile.DefaultHeight;
