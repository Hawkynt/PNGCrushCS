...
[TestFixture]
public sealed class Wad3ReaderTests {

  [Test]
  [Category("Unit")]
  public void FromBytes_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => Wad3Reader.FromBytes(null!));
  }

  [Test]
  [Category("Unit")]
  public void FromFile_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => Wad3Reader.FromFile(null!));
  }
  ...
  public void FromFile_Missing_ThrowsFileNotFoundException() {
    ...
    Assert.Throws<FileNotFoundException>(() => Wad3Reader.FromFile(missing));
  }

  [Test]
  [Category("Unit")]
  public void FromStream_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => Wad3Reader.FromStream(null!));
  }
  ...
  public void FromBytes_TooSmall_ThrowsInvalidDataException() {
    ...
    Assert.Throws<InvalidDataException>(() => Wad3Reader.FromBytes(tooSmall));
  }

  [Test]
  [Category("Unit")]
  public void FromBytes_InvalidMagic_ThrowsInvalidDataException() {
    var bad = new byte[Wad3Header.StructSize];
    bad[0] = (byte)'W';
    bad[1] = (byte)'A';
    bad[2] = (byte)'D';
    bad[3] = (byte)'2'; // Wrong version
    Assert.Throws<InvalidDataException>(() => Wad3Reader.FromBytes(bad));
  }
  ...
  public void FromBytes_ValidSingleTexture_ParsesCorrectly() {
    ...
    var result = Wad3Reader.FromBytes(bytes);
  ...
  public void FromBytes_ValidMultiTexture_ParsesAll() {
    ...
    var bytes = Wad3Writer.ToBytes(new Wad3File { Textures = [tex1, tex2] });
  ...
  public void FromStream_ValidTexture_ParsesCorrectly() {
    ...
    var result = Wad3Reader.FromStream(ms);
