...
public sealed class RoundTripTests {
  ...
  public void WriteThenRead_PreservesData() {
    ...
    var bytes = CentauriWriter.ToBytes(original);
    var roundTripped = CentauriReader.FromBytes(bytes);
  ...
  public void Reader_NullBytes_ThrowsArgumentNullException() {
    Assert.That(() => CentauriReader.FromBytes(null!), Throws.TypeOf<ArgumentNullException>());
  }

  [Test]
  public void Writer_NullFile_ThrowsArgumentNullException() {
    Assert.That(() => CentauriWriter.ToBytes(null!), Throws.TypeOf<ArgumentNullException>());
  }
}
