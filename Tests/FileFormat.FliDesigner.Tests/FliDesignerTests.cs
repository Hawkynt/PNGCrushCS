...
[TestFixture]
public sealed class FliDesignerWriterTests {

  [Test]
  [Category("Unit")]
  public void ToBytes_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => FliDesignerWriter.ToBytes(null!));
  }
  ...
  public void ToBytes_CorrectOutputSize() {
    ...
    var file = new FliDesignerFile { LoadAddress = 0x3C00, RawData = rawData };
    var bytes = FliDesignerWriter.ToBytes(file);
  ...
  public void ToBytes_LoadAddress_LittleEndian() {
    var file = new FliDesignerFile { LoadAddress = 0xABCD, RawData = new byte[17000] };
    var bytes = FliDesignerWriter.ToBytes(file);
...
[TestFixture]
public sealed class FliDesignerDataTypeTests {

  [Test]
  [Category("Unit")]
  public void PrimaryExtension_IsFd2() {
    Assert.That(_GetPrimaryExtension(), Is.EqualTo(".fd2"));
  }

  [Test]
  [Category("Unit")]
  public void FileExtensions_ContainsFd2() {
    var extensions = _GetFileExtensions();
    Assert.That(extensions, Does.Contain(".fd2"));
  }

  [Test]
  [Category("Unit")]
  public void ToRawImage_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => FliDesignerFile.ToRawImage(null!));
  }

  [Test]
  [Category("Unit")]
  public void FromRawImage_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => FliDesignerFile.FromRawImage(null!));
  }
  ...
  public void FromRawImage_ThrowsNotSupportedException() {
    ...
    Assert.Throws<NotSupportedException>(() => FliDesignerFile.FromRawImage(image));
  }

  [Test]
  [Category("Unit")]
  public void FixedWidth_Is160() {
    Assert.That(FliDesignerFile.FixedWidth, Is.EqualTo(160));
  }

  [Test]
  [Category("Unit")]
  public void FixedHeight_Is200() {
    Assert.That(FliDesignerFile.FixedHeight, Is.EqualTo(200));
  }
  ...
  public void ToRawImage_ProducesRgb24() {
    var data = TestHelpers._BuildValidFliDesignerData(0x3C00);
    var file = FliDesignerReader.FromBytes(data);
    var rawImage = FliDesignerFile.ToRawImage(file);
  ...
  public void ScreenBankCount_Is8() {
    Assert.That(FliDesignerFile.ScreenBankCount, Is.EqualTo(8));
  }

  [Test]
  [Category("Unit")]
  public void MinPayloadSize_IsBitmapPlus8ScreensPlusColor() {
    Assert.That(FliDesignerFile.MinPayloadSize, Is.EqualTo(8000 + 8 * 1000 + 1000));
  }

  [Test]
  [Category("Unit")]
  public void DefaultRawData_IsEmpty() {
    var file = new FliDesignerFile();
    Assert.That(file.RawData, Is.Empty);
  }

  private static string _GetPrimaryExtension() => _Helper<FliDesignerFile>.PrimaryExtension;
  private static string[] _GetFileExtensions() => _Helper<FliDesignerFile>.FileExtensions;
