...
public sealed class DataTypeTests {
  ...
  public void ImageWidth_Is160() {
    Assert.That(McsFile.ImageWidth, Is.EqualTo(160));
  }

  [Test]
  [Category("Unit")]
  public void ImageHeight_Is200() {
    Assert.That(McsFile.ImageHeight, Is.EqualTo(200));
  }

  [Test]
  [Category("Unit")]
  public void MinFileSize_Is10003() {
    Assert.That(McsFile.MinFileSize, Is.EqualTo(10003));
  }
  ...
  public void FromRawImage_ThrowsNotSupportedException() {
    ...
    Assert.Throws<NotSupportedException>(() => McsFile.FromRawImage(raw));
  }

  [Test]
  [Category("Unit")]
  public void ToRawImage_NullFile_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => McsFile.ToRawImage(null!));
  }
}
