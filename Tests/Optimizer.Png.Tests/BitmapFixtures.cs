...
/// <summary>Turns the bitmap fixtures these tests draw into the picture the optimizer now takes.</summary>
/// <remarks>
/// The optimizer speaks in <see cref="RawImage"/> so that it can run anywhere; these tests still
/// build their fixtures with <c>SetPixel</c> and read their results back through GDI+, which is why
/// they remain a Windows-only fixture. This is the one place the two meet.
/// </remarks>
internal static class BitmapFixtures {
