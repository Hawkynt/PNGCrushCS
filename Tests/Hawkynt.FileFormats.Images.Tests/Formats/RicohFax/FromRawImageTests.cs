...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_BiLevelPicture_IsExact() {
    ...
    var bytes = RicohFaxWriter.ToBytes(RicohFaxFile.FromRawImage(source));
    var back = RicohFaxFile.ToRawImage(RicohFaxReader.FromBytes(bytes));
  ...
  public void FromRawImage_FullColourOddSize_IsAcceptedNotRefused() {
    ...
    var file = RicohFaxFile.FromRawImage(source);
    var back = RicohFaxFile.ToRawImage(RicohFaxReader.FromBytes(RicohFaxWriter.ToBytes(file)));
