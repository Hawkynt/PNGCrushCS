...
using FileFormat.PhotoLine;

namespace FileFormat.PhotoLine.Tests;
...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_EveryPixelComesBack() {
    ...
    var restored = PhotoLineReader.FromBytes(PhotoLineWriter.ToBytes(PhotoLineFile.FromRawImage(source)));
    var decoded = PhotoLineFile.ToRawImage(restored);
  ...
  public void AnySizeIsAccepted() {
    ...
    var decoded = PhotoLineFile.ToRawImage(PhotoLineReader.FromBytes(PhotoLineWriter.ToBytes(PhotoLineFile.FromRawImage(_Picture(1, 1)))));
  ...
  public void FromRawImage_Null_ThrowsArgumentNullException()
    => Assert.Throws<ArgumentNullException>(() => PhotoLineFile.FromRawImage(null!));
}
