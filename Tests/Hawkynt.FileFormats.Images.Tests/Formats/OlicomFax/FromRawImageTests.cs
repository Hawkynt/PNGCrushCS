...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_BiLevelPicture_IsExact() {
    ...
    var bytes = OlicomFaxWriter.ToBytes(OlicomFaxFile.FromRawImage(source));
    var back = OlicomFaxFile.ToRawImage(OlicomFaxReader.FromBytes(bytes));
  ...
  public void FromRawImage_FullColourOddSize_IsAcceptedNotRefused() {
    ...
    var file = OlicomFaxFile.FromRawImage(source);
    var back = OlicomFaxFile.ToRawImage(OlicomFaxReader.FromBytes(OlicomFaxWriter.ToBytes(file)));
