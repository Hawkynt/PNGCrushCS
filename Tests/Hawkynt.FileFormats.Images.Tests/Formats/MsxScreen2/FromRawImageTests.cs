...
public sealed class FromRawImageTests {
  ...
  public void FromRawImage_ScalesAPictureOfAnyOtherSize() {
    ...
    var small = MsxScreen2File.ToRawImage(MsxScreen2File.FromRawImage(Raw(100, 100)));
    var large = MsxScreen2File.ToRawImage(MsxScreen2File.FromRawImage(Raw(640, 480)));
