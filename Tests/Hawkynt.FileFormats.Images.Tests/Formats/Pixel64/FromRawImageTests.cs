...
public sealed class FromRawImageTests {
  ...
  private static RawImage _SolidCells() {
    const int width = Pixel64File.FixedWidth, height = Pixel64File.FixedHeight;
  ...
  public void RoundTrip_SolidCells_ReproducesExactly() {
    ...
    var file = Pixel64File.FromRawImage(source);
    var restored = Pixel64Reader.FromBytes(Pixel64Writer.ToBytes(file));
    var decoded = Pixel64File.ToRawImage(restored);
  ...
  public void FromRawImage_ScalesAPictureOfAnyOtherSize() {
    ...
    var small = Pixel64File.ToRawImage(Pixel64File.FromRawImage(Raw(100, 100)));
    var large = Pixel64File.ToRawImage(Pixel64File.FromRawImage(Raw(640, 480)));
