...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_BiLevelPicture_IsExact() {
    ...
    var bytes = SmartFaxWriter.ToBytes(SmartFaxFile.FromRawImage(source));
    var back = SmartFaxFile.ToRawImage(SmartFaxReader.FromBytes(bytes));
  ...
  public void FromRawImage_FullColourOddSize_IsAcceptedNotRefused() {
    ...
    var file = SmartFaxFile.FromRawImage(source);
    var back = SmartFaxFile.ToRawImage(SmartFaxReader.FromBytes(SmartFaxWriter.ToBytes(file)));
