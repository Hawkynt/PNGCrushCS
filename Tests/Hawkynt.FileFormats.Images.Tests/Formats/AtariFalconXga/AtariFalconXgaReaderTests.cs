...
public sealed class AtariFalconXgaReaderTests {
  ...
  public void FromBytes_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => AtariFalconXgaReader.FromBytes(null!));
  }

  [Test]
  [Category("Unit")]
  public void FromFile_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => AtariFalconXgaReader.FromFile(null!));
  }

  [Test]
  [Category("Unit")]
  public void FromFile_Missing_ThrowsFileNotFoundException() {
    var missing = new FileInfo(Path.Combine(Path.GetTempPath(), Guid.NewGuid() + ".xga"));
    Assert.Throws<FileNotFoundException>(() => AtariFalconXgaReader.FromFile(missing));
  }

  [Test]
  [Category("Unit")]
  public void FromStream_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => AtariFalconXgaReader.FromStream(null!));
  }
  ...
  public void FromBytes_TooSmall_ThrowsInvalidDataException() {
    ...
    Assert.Throws<InvalidDataException>(() => AtariFalconXgaReader.FromBytes(tooSmall));
  }

  [Test]
  [Category("Unit")]
  public void FromBytes_ZeroWidth_ThrowsInvalidDataException() {
    var data = new byte[AtariFalconXgaHeader.StructSize];
    BinaryPrimitives.WriteUInt16BigEndian(data.AsSpan(0), 0);
    BinaryPrimitives.WriteUInt16BigEndian(data.AsSpan(2), 10);
    Assert.Throws<InvalidDataException>(() => AtariFalconXgaReader.FromBytes(data));
  }
  ...
  public void FromBytes_TruncatedPixelData_ThrowsInvalidDataException() {
    var data = new byte[AtariFalconXgaHeader.StructSize + 2];
    BinaryPrimitives.WriteUInt16BigEndian(data.AsSpan(0), 10);
    BinaryPrimitives.WriteUInt16BigEndian(data.AsSpan(2), 10);
    Assert.Throws<InvalidDataException>(() => AtariFalconXgaReader.FromBytes(data));
  }
  ...
  public void FromBytes_Valid_ParsesDimensions() {
    ...
    var result = AtariFalconXgaReader.FromBytes(data);
  ...
  public void FromStream_Valid() {
    ...
    var result = AtariFalconXgaReader.FromStream(ms);
  ...
  public void FromBytes_CopiesInputData() {
    ...
    var result = AtariFalconXgaReader.FromBytes(data);
    data[AtariFalconXgaHeader.StructSize] = 0x00;
