...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_BiLevelPicture_IsExact() {
    ...
    var bytes = AdTechFaxWriter.ToBytes(AdTechFaxFile.FromRawImage(source));
    var back = AdTechFaxFile.ToRawImage(AdTechFaxReader.FromBytes(bytes));
  ...
  public void FromRawImage_FullColourOddSize_IsAcceptedNotRefused() {
    ...
    var file = AdTechFaxFile.FromRawImage(source);
    var back = AdTechFaxFile.ToRawImage(AdTechFaxReader.FromBytes(AdTechFaxWriter.ToBytes(file)));
