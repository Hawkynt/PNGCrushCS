...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_CheckerboardOfCells_ReproducesExactly() {
    ...
    var file = ZxPaintbrushFile.FromRawImage(source);
    var restored = ZxPaintbrushReader.FromBytes(ZxPaintbrushWriter.ToBytes(file));
    var decoded = ZxPaintbrushFile.ToRawImage(restored);
  ...
  public void FromRawImage_ScalesAPictureOfAnyOtherSize() {
    ...
    var small = ZxPaintbrushFile.ToRawImage(ZxPaintbrushFile.FromRawImage(Raw(100, 100)));
    var large = ZxPaintbrushFile.ToRawImage(ZxPaintbrushFile.FromRawImage(Raw(640, 480)));
