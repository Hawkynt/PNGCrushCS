...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_BiLevelPicture_IsExact() {
    ...
    var bytes = GammaFaxWriter.ToBytes(GammaFaxFile.FromRawImage(source));
    var back = GammaFaxFile.ToRawImage(GammaFaxReader.FromBytes(bytes));
  ...
  public void FromRawImage_FullColourOddSize_IsAcceptedNotRefused() {
    ...
    var file = GammaFaxFile.FromRawImage(source);
    var back = GammaFaxFile.ToRawImage(GammaFaxReader.FromBytes(GammaFaxWriter.ToBytes(file)));
