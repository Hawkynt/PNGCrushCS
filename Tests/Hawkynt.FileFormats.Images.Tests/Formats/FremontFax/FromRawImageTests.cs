...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_BiLevelPicture_IsExact() {
    ...
    var bytes = FremontFaxWriter.ToBytes(FremontFaxFile.FromRawImage(source));
    var back = FremontFaxFile.ToRawImage(FremontFaxReader.FromBytes(bytes));
  ...
  public void FromRawImage_FullColourOddSize_IsAcceptedNotRefused() {
    ...
    var file = FremontFaxFile.FromRawImage(source);
    var back = FremontFaxFile.ToRawImage(FremontFaxReader.FromBytes(FremontFaxWriter.ToBytes(file)));
