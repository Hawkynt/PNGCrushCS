...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_CheckerboardOfCells_ReproducesExactly() {
    ...
    var file = ZxMlgFile.FromRawImage(source);
    var restored = ZxMlgReader.FromBytes(ZxMlgWriter.ToBytes(file));
    var decoded = ZxMlgFile.ToRawImage(restored);
  ...
  public void FromRawImage_ScalesAPictureOfAnyOtherSize() {
    ...
    var small = ZxMlgFile.ToRawImage(ZxMlgFile.FromRawImage(Raw(100, 100)));
    var large = ZxMlgFile.ToRawImage(ZxMlgFile.FromRawImage(Raw(640, 480)));
