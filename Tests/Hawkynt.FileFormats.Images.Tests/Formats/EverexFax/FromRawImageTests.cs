...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_BiLevelPicture_IsExact() {
    ...
    var bytes = EverexFaxWriter.ToBytes(EverexFaxFile.FromRawImage(source));
    var back = EverexFaxFile.ToRawImage(EverexFaxReader.FromBytes(bytes));
  ...
  public void FromRawImage_FullColourOddSize_IsAcceptedNotRefused() {
    ...
    var file = EverexFaxFile.FromRawImage(source);
    var back = EverexFaxFile.ToRawImage(EverexFaxReader.FromBytes(EverexFaxWriter.ToBytes(file)));
