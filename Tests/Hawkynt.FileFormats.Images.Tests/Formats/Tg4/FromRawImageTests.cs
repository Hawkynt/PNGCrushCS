...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_BiLevelPicture_IsExact() {
    ...
    var bytes = Tg4Writer.ToBytes(Tg4File.FromRawImage(source));
    var back = Tg4File.ToRawImage(Tg4Reader.FromBytes(bytes));
  ...
  public void FromRawImage_FullColourOddSize_IsAcceptedNotRefused() {
    ...
    var file = Tg4File.FromRawImage(source);
    var back = Tg4File.ToRawImage(Tg4Reader.FromBytes(Tg4Writer.ToBytes(file)));
