...
public sealed class FromRawImageTests {
  ...
  public void FromRawImage_ScalesAPictureOfAnyOtherSize() {
    ...
    var small = ZxBorderMulticolorFile.ToRawImage(ZxBorderMulticolorFile.FromRawImage(Raw(100, 100)));
    var large = ZxBorderMulticolorFile.ToRawImage(ZxBorderMulticolorFile.FromRawImage(Raw(640, 480)));
