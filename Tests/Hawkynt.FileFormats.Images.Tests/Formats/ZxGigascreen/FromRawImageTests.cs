...
public sealed class FromRawImageTests {
  ...
  public void FromRawImage_ScalesAPictureOfAnyOtherSize() {
    ...
    var small = ZxGigascreenFile.ToRawImage(ZxGigascreenFile.FromRawImage(Raw(100, 100)));
    var large = ZxGigascreenFile.ToRawImage(ZxGigascreenFile.FromRawImage(Raw(640, 480)));
