...
public sealed class FromRawImageTests {
  ...
  public void FromRawImage_ScalesAPictureOfAnyOtherSize() {
    ...
    var small = ZxBorderScreenFile.ToRawImage(ZxBorderScreenFile.FromRawImage(Raw(100, 100)));
    var large = ZxBorderScreenFile.ToRawImage(ZxBorderScreenFile.FromRawImage(Raw(640, 480)));
