...
using FileFormat.PhotoStudio;

namespace FileFormat.PhotoStudio.Tests;
...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_EveryPixelComesBack() {
    ...
    var restored = PhotoStudioReader.FromBytes(PhotoStudioWriter.ToBytes(PhotoStudioFile.FromRawImage(source)));
    var decoded = PhotoStudioFile.ToRawImage(restored);
  ...
  public void AnySizeIsAccepted() {
    ...
    var decoded = PhotoStudioFile.ToRawImage(PhotoStudioReader.FromBytes(PhotoStudioWriter.ToBytes(PhotoStudioFile.FromRawImage(_Picture(1, 1)))));
  ...
  public void FromRawImage_Null_ThrowsArgumentNullException()
    => Assert.Throws<ArgumentNullException>(() => PhotoStudioFile.FromRawImage(null!));
}
