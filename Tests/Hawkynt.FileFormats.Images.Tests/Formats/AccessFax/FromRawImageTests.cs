...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_BiLevelPicture_IsExact() {
    ...
    var bytes = AccessFaxWriter.ToBytes(AccessFaxFile.FromRawImage(source));
    var back = AccessFaxFile.ToRawImage(AccessFaxReader.FromBytes(bytes));
  ...
  public void FromRawImage_FullColourOddSize_IsAcceptedNotRefused() {
    ...
    var file = AccessFaxFile.FromRawImage(source);
    var back = AccessFaxFile.ToRawImage(AccessFaxReader.FromBytes(AccessFaxWriter.ToBytes(file)));
