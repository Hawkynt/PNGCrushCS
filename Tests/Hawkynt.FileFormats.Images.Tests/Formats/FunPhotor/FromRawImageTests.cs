...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_EveryPixelComesBack() {
    ...
    var restored = FunPhotorReader.FromBytes(FunPhotorWriter.ToBytes(FunPhotorFile.FromRawImage(source)));
    var decoded = FunPhotorFile.ToRawImage(restored);
  ...
  public void AnySizeIsAccepted() {
    ...
    var decoded = FunPhotorFile.ToRawImage(FunPhotorReader.FromBytes(FunPhotorWriter.ToBytes(FunPhotorFile.FromRawImage(_Picture(1, 1)))));
  ...
  public void FromRawImage_Null_ThrowsArgumentNullException()
    => Assert.Throws<ArgumentNullException>(() => FunPhotorFile.FromRawImage(null!));
}
