...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_BiLevelPicture_IsExact() {
    ...
    var bytes = ImagingFaxWriter.ToBytes(ImagingFaxFile.FromRawImage(source));
    var back = ImagingFaxFile.ToRawImage(ImagingFaxReader.FromBytes(bytes));
  ...
  public void FromRawImage_FullColourOddSize_IsAcceptedNotRefused() {
    ...
    var file = ImagingFaxFile.FromRawImage(source);
    var back = ImagingFaxFile.ToRawImage(ImagingFaxReader.FromBytes(ImagingFaxWriter.ToBytes(file)));
