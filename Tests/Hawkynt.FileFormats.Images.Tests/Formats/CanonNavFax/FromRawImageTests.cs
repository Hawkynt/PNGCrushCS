...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_BiLevelPicture_IsExact() {
    ...
    var bytes = CanonNavFaxWriter.ToBytes(CanonNavFaxFile.FromRawImage(source));
    var back = CanonNavFaxFile.ToRawImage(CanonNavFaxReader.FromBytes(bytes));
  ...
  public void FromRawImage_FullColourOddSize_IsAcceptedNotRefused() {
    ...
    var file = CanonNavFaxFile.FromRawImage(source);
    var back = CanonNavFaxFile.ToRawImage(CanonNavFaxReader.FromBytes(CanonNavFaxWriter.ToBytes(file)));
