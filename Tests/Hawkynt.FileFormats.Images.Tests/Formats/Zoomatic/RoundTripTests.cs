...
public sealed class RoundTripTests {
  ...
  public void RoundTrip_AllFieldsPreserved() {
    ...
    var bytes = ZoomaticWriter.ToBytes(original);
    var restored = ZoomaticReader.FromBytes(bytes);
  ...
  public void RoundTrip_ViaFile_PreservesData() {
    ...
    var tmpPath = Path.Combine(Path.GetTempPath(), Guid.NewGuid() + ".zom");
    try {
      var bytes = ZoomaticWriter.ToBytes(original);
      File.WriteAllBytes(tmpPath, bytes);
      var restored = ZoomaticReader.FromFile(new FileInfo(tmpPath));
  ...
  public void RoundTrip_ToRawImage_ProducesCorrectDimensions() {
    ...
    var raw = ZoomaticFile.ToRawImage(original);
