...
using FileFormat.NeroCoverDesigner;

namespace FileFormat.NeroCoverDesigner.Tests;
...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_EveryPixelComesBack() {
    ...
    var restored = NeroCoverDesignerReader.FromBytes(NeroCoverDesignerWriter.ToBytes(NeroCoverDesignerFile.FromRawImage(source)));
    var decoded = NeroCoverDesignerFile.ToRawImage(restored);
  ...
  public void AnySizeIsAccepted() {
    ...
    var decoded = NeroCoverDesignerFile.ToRawImage(NeroCoverDesignerReader.FromBytes(NeroCoverDesignerWriter.ToBytes(NeroCoverDesignerFile.FromRawImage(_Picture(1, 1)))));
  ...
  public void FromRawImage_Null_ThrowsArgumentNullException()
    => Assert.Throws<ArgumentNullException>(() => NeroCoverDesignerFile.FromRawImage(null!));
}
