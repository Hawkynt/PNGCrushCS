...
using FileFormat.EsmSoftwarePix;

namespace FileFormat.EsmSoftwarePix.Tests;
...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_EveryPixelComesBack() {
    ...
    var restored = EsmSoftwarePixReader.FromBytes(EsmSoftwarePixWriter.ToBytes(EsmSoftwarePixFile.FromRawImage(source)));
    var decoded = EsmSoftwarePixFile.ToRawImage(restored);
  ...
  public void AnySizeIsAccepted() {
    ...
    var decoded = EsmSoftwarePixFile.ToRawImage(EsmSoftwarePixReader.FromBytes(EsmSoftwarePixWriter.ToBytes(EsmSoftwarePixFile.FromRawImage(_Picture(1, 1)))));
  ...
  public void FromRawImage_Null_ThrowsArgumentNullException()
    => Assert.Throws<ArgumentNullException>(() => EsmSoftwarePixFile.FromRawImage(null!));
}
