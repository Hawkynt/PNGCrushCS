...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_BiLevelPicture_IsExact() {
    ...
    var bytes = AttGroup4Writer.ToBytes(AttGroup4File.FromRawImage(source));
    var back = AttGroup4File.ToRawImage(AttGroup4Reader.FromBytes(bytes));
  ...
  public void FromRawImage_FullColourOddSize_IsAcceptedNotRefused() {
    ...
    var file = AttGroup4File.FromRawImage(source);
    var back = AttGroup4File.ToRawImage(AttGroup4Reader.FromBytes(AttGroup4Writer.ToBytes(file)));
