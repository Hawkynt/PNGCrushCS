...
public sealed class RoundTripTests {
  ...
  public void RoundTrip_SingleTexture() {
    ...
    var original = new Wad3File { Textures = [texture] };

    var bytes = Wad3Writer.ToBytes(original);
  ...
  public void RoundTrip_MultiTexture() {
    ...
    var original = new Wad3File { Textures = [tex1, tex2] };
  ...
  public void RoundTrip_ViaFile() {
    ...
    try {
      ...
      var restored = Wad3Reader.FromFile(new FileInfo(tempPath));
