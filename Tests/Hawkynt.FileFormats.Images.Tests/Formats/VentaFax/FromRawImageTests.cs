...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_BiLevelPicture_IsExact() {
    ...
    var bytes = VentaFaxWriter.ToBytes(VentaFaxFile.FromRawImage(source));
    var back = VentaFaxFile.ToRawImage(VentaFaxReader.FromBytes(bytes));
  ...
  public void FromRawImage_FullColourOddSize_IsAcceptedNotRefused() {
    ...
    var file = VentaFaxFile.FromRawImage(source);
    var back = VentaFaxFile.ToRawImage(VentaFaxReader.FromBytes(VentaFaxWriter.ToBytes(file)));
