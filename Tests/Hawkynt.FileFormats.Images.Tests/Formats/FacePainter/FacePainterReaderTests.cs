using System;
using System.IO;
using FileFormat.FacePainter;

namespace FileFormat.FacePainter.Tests;

[TestFixture]
public sealed class FacePainterReaderTests {

  [Test]
  [Category("Unit")]
  public void FromBytes_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => FacePainterReader.FromBytes(null!));
  }

  [Test]
  [Category("Unit")]
  public void FromFile_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => FacePainterReader.FromFile(null!));
  }

  [Test]
  [Category("Unit")]
  public void FromFile_Missing_ThrowsFileNotFoundException() {
    var missing = new FileInfo(Path.Combine(Path.GetTempPath(), Guid.NewGuid() + ".fpt"));
    Assert.Throws<FileNotFoundException>(() => FacePainterReader.FromFile(missing));
  }

  [Test]
  [Category("Unit")]
  public void FromStream_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => FacePainterReader.FromStream(null!));
  }

  [Test]
  [Category("Unit")]
  public void FromBytes_TooSmall_ThrowsInvalidDataException() {
    Assert.Throws<InvalidDataException>(() => FacePainterReader.FromBytes(new byte[100]));
  }

  [Test]
  [Category("Unit")]
  public void FromBytes_WrongSize_ThrowsInvalidDataException() {
    Assert.Throws<InvalidDataException>(() => FacePainterReader.FromBytes(new byte[10003]));
  }
  ...
  public void FromBytes_ValidParsesCorrectly() {
    ...
    var result = FacePainterReader.FromBytes(data);
  ...
  public void FromBytes_LoadAddress_ParsedAsLittleEndian() {
    var data = new byte[FacePainterFile.ExpectedFileSize];
    data[0] = 0x00;
    data[1] = 0x40;
    var result = FacePainterReader.FromBytes(data);
  ...
  public void FromStream_ValidParsesCorrectly() {
    ...
    var result = FacePainterReader.FromStream(ms);
  ...
  public void RoundTrip_AllFieldsPreserved() {
    ...
    var original = new FacePainterFile {
      LoadAddress = 0x4000,
    ...
    var bytes = FacePainterWriter.ToBytes(original);
    var restored = FacePainterReader.FromBytes(bytes);
