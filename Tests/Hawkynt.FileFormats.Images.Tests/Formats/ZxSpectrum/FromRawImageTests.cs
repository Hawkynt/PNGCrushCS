...
public sealed class FromRawImageTests {
  ...
  public void FromRawImage_ScalesAPictureOfAnyOtherSize() {
    ...
    var small = ZxSpectrumFile.ToRawImage(ZxSpectrumFile.FromRawImage(Raw(100, 100)));
    var large = ZxSpectrumFile.ToRawImage(ZxSpectrumFile.FromRawImage(Raw(640, 480)));
