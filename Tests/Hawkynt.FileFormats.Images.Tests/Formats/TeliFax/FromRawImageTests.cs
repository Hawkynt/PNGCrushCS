...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_BiLevelPicture_IsExact() {
    ...
    var bytes = TeliFaxWriter.ToBytes(TeliFaxFile.FromRawImage(source));
    var back = TeliFaxFile.ToRawImage(TeliFaxReader.FromBytes(bytes));
  ...
  public void FromRawImage_FullColourOddSize_IsAcceptedNotRefused() {
    ...
    var file = TeliFaxFile.FromRawImage(source);
    var back = TeliFaxFile.ToRawImage(TeliFaxReader.FromBytes(TeliFaxWriter.ToBytes(file)));
