...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_BiLevelPicture_IsExact() {
    ...
    var bytes = WorldportFaxWriter.ToBytes(WorldportFaxFile.FromRawImage(source));
    var back = WorldportFaxFile.ToRawImage(WorldportFaxReader.FromBytes(bytes));
  ...
  public void FromRawImage_FullColourOddSize_IsAcceptedNotRefused() {
    ...
    var file = WorldportFaxFile.FromRawImage(source);
    var back = WorldportFaxFile.ToRawImage(WorldportFaxReader.FromBytes(WorldportFaxWriter.ToBytes(file)));
