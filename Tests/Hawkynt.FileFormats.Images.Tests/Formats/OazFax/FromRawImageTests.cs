...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_BiLevelPicture_IsExact() {
    ...
    var bytes = OazFaxWriter.ToBytes(OazFaxFile.FromRawImage(source));
    var back = OazFaxFile.ToRawImage(OazFaxReader.FromBytes(bytes));
  ...
  public void FromRawImage_FullColourOddSize_IsAcceptedNotRefused() {
    ...
    var file = OazFaxFile.FromRawImage(source);
    var back = OazFaxFile.ToRawImage(OazFaxReader.FromBytes(OazFaxWriter.ToBytes(file)));
