...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_BiLevelPicture_IsExact() {
    ...
    var bytes = BrotherFaxWriter.ToBytes(BrotherFaxFile.FromRawImage(source));
    var back = BrotherFaxFile.ToRawImage(BrotherFaxReader.FromBytes(bytes));
  ...
  public void FromRawImage_FullColourOddSize_IsAcceptedNotRefused() {
    ...
    var file = BrotherFaxFile.FromRawImage(source);
    var back = BrotherFaxFile.ToRawImage(BrotherFaxReader.FromBytes(BrotherFaxWriter.ToBytes(file)));
