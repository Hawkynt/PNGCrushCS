...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_BiLevelPicture_IsExact() {
    ...
    var bytes = FaxManWriter.ToBytes(FaxManFile.FromRawImage(source));
    var back = FaxManFile.ToRawImage(FaxManReader.FromBytes(bytes));
  ...
  public void FromRawImage_FullColourOddSize_IsAcceptedNotRefused() {
    ...
    var file = FaxManFile.FromRawImage(source);
    var back = FaxManFile.ToRawImage(FaxManReader.FromBytes(FaxManWriter.ToBytes(file)));
