...
public sealed class FromRawImageTests {
  ...
  public void FromRawImage_ScalesAPictureOfAnyOtherSize() {
    ...
    var small = ZxMultiArtistFile.ToRawImage(ZxMultiArtistFile.FromRawImage(Raw(100, 100)));
    var large = ZxMultiArtistFile.ToRawImage(ZxMultiArtistFile.FromRawImage(Raw(640, 480)));
