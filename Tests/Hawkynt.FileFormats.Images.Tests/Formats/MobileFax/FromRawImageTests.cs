...
public sealed class FromRawImageTests {
  ...
  public void RoundTrip_BiLevelPicture_IsExact() {
    ...
    var bytes = MobileFaxWriter.ToBytes(MobileFaxFile.FromRawImage(source));
    var back = MobileFaxFile.ToRawImage(MobileFaxReader.FromBytes(bytes));
  ...
  public void FromRawImage_FullColourOddSize_IsAcceptedNotRefused() {
    ...
    var file = MobileFaxFile.FromRawImage(source);
    var back = MobileFaxFile.ToRawImage(MobileFaxReader.FromBytes(MobileFaxWriter.ToBytes(file)));
