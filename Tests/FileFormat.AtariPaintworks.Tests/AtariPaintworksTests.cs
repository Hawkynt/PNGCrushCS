...
[TestFixture]
public sealed class AtariPaintworksWriterTests {

  [Test]
  [Category("Unit")]
  public void ToBytes_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => AtariPaintworksWriter.ToBytes(null!));
  }

  [Test]
  [Category("Unit")]
  public void ToBytes_OutputIs32032Bytes() {
    var file = new AtariPaintworksFile {
      Width = 320,
      Height = 200,
    ...
    var bytes = AtariPaintworksWriter.ToBytes(file);
...
public sealed class DataTypeTests {
  ...
  [Test]
  [Category("Unit")]
  public void AtariPaintworksResolution_HasExpectedValues() {
    Assert.That((int)AtariPaintworksResolution.Low, Is.EqualTo(0));
    Assert.That((int)AtariPaintworksResolution.Medium, Is.EqualTo(1));
    Assert.That((int)AtariPaintworksResolution.High, Is.EqualTo(2));

    var values = Enum.GetValues<AtariPaintworksResolution>();
    Assert.That(values, Has.Length.EqualTo(3));
  }

  [Test]
  [Category("Unit")]
  public void AtariPaintworksFile_Defaults() {
    var file = new AtariPaintworksFile();
    Assert.Multiple(() => {
      Assert.That(file.Width, Is.EqualTo(0));
      Assert.That(file.Height, Is.EqualTo(0));
      Assert.That(file.Resolution, Is.EqualTo(AtariPaintworksResolution.Low));
  ...
  [Test]
  [Category("Unit")]
  public void AtariPaintworksFile_CanRoundTripThroughInterface() {
    // Exercise the IImageFileFormat interface by creating, writing, and re-reading
    var file = new AtariPaintworksFile {
      Width = 320,
      Height = 200,
      Resolution = AtariPaintworksResolution.Low,
  ...
  public void ToRawImage_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => AtariPaintworksFile.ToRawImage(null!));
  }

  [Test]
  [Category("Unit")]
  public void FromRawImage_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => AtariPaintworksFile.FromRawImage(null!));
  }
  ...
  public void FromRawImage_WrongFormat_ThrowsArgumentException() {
    ...
    Assert.Throws<ArgumentException>(() => AtariPaintworksFile.FromRawImage(raw));
  }
}
