...
[TestFixture]
public class ZxMlgWriterTests {

  [Test]
  public void ToBytes_NullFile_ThrowsArgumentNullException()
    => Assert.Throws<ArgumentNullException>(() => ZxMlgWriter.ToBytes(null!));

  [Test]
  public void ToBytes_OutputSize_Is6912() {
    var file = new ZxMlgFile {
      BitmapData = new byte[6144],
      AttributeData = new byte[768],
    };
    var bytes = ZxMlgWriter.ToBytes(file);
  ...
  public void ToBytes_AttributeData_Preserved() {
    ...
    var bytes = ZxMlgWriter.ToBytes(file);
    var result = ZxMlgReader.FromBytes(bytes);
...
public class DataTypeTests {
  ...
  public void ToRawImage_NullFile_ThrowsArgumentNullException()
    => Assert.Throws<ArgumentNullException>(() => ZxMlgFile.ToRawImage(null!));

  [Test]
  public void FromRawImage_NullImage_ThrowsArgumentNullException()
    => Assert.Throws<ArgumentNullException>(() => ZxMlgFile.FromRawImage(null!));

  [Test]
  public void FromRawImage_ThrowsNotSupportedException() {
    var raw = new RawImage { Width = 256, Height = 192, Format = PixelFormat.Rgb24, PixelData = new byte[256 * 192 * 3] };
    Assert.Throws<NotSupportedException>(() => ZxMlgFile.FromRawImage(raw));
  }
  ...
  public void ToRawImage_ReturnsRgb24() {
    ...
    var raw = ZxMlgFile.ToRawImage(file);
