...
public sealed class DataTypeTests {
  ...
  [Test]
  [Category("Unit")]
  public void AtariFalconXgaFile_DefaultPixelData_IsEmptyArray() {
    var file = new AtariFalconXgaFile();
  ...
  [Test]
  [Category("Unit")]
  public void AtariFalconXgaFile_DefaultDimensions_AreZero() {
    var file = new AtariFalconXgaFile();
  ...
  [Test]
  [Category("Unit")]
  public void AtariFalconXgaFile_InitProperties_RoundTrip() {
  ...
  [Test]
  [Category("Unit")]
  public void AtariFalconXgaFile_PrimaryExtension_IsXga() {
    var ext = _GetStaticProperty<string>("PrimaryExtension");
    Assert.That(ext, Is.EqualTo(".xga"));
  }

  [Test]
  [Category("Unit")]
  public void AtariFalconXgaFile_FileExtensions_ContainsXga() {
    var exts = _GetStaticProperty<string[]>("FileExtensions");
    Assert.That(exts, Has.Length.EqualTo(1));
    Assert.That(exts, Does.Contain(".xga"));
  }

  [Test]
  [Category("Unit")]
  public void ToRawImage_Null_Throws() {
    Assert.Throws<ArgumentNullException>(() => AtariFalconXgaFile.ToRawImage(null!));
  }
  ...
  public void ToRawImage_ReturnsRgb24() {
    ...
    var raw = AtariFalconXgaFile.ToRawImage(file);
  ...
  public void FromRawImage_Null_Throws() {
    Assert.Throws<ArgumentNullException>(() => AtariFalconXgaFile.FromRawImage(null!));
  }
  ...
  public void FromRawImage_WrongFormat_Throws() {
    ...
    Assert.Throws<ArgumentException>(() => AtariFalconXgaFile.FromRawImage(raw));
  }
  ...
  private static T _GetStaticProperty<T>(string name) {
    var prop = typeof(AtariFalconXgaFile).GetInterfaceMap(typeof(IImageFileFormat<AtariFalconXgaFile>));
