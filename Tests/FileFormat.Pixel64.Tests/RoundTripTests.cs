...
public sealed class RoundTripTests {
  ...
  public void WriteThenRead_PreservesData() {
    ...
    var bytes = Pixel64Writer.ToBytes(original);
    var roundTripped = Pixel64Reader.FromBytes(bytes);
  ...
  public void Reader_NullBytes_ThrowsArgumentNullException() {
    Assert.That(() => Pixel64Reader.FromBytes(null!), Throws.TypeOf<ArgumentNullException>());
  }

  [Test]
  public void Writer_NullFile_ThrowsArgumentNullException() {
    Assert.That(() => Pixel64Writer.ToBytes(null!), Throws.TypeOf<ArgumentNullException>());
  }
}
