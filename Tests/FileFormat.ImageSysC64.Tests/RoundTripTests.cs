...
public sealed class RoundTripTests {
  ...
  public void WriteThenRead_PreservesData() {
    var original = new ImageSysC64File {
      LoadAddress = 0x2000,
    ...
    var bytes = ImageSysC64Writer.ToBytes(original);
    var roundTripped = ImageSysC64Reader.FromBytes(bytes);
  ...
  public void Reader_NullBytes_ThrowsArgumentNullException() {
    Assert.That(() => ImageSysC64Reader.FromBytes(null!), Throws.TypeOf<ArgumentNullException>());
  }

  [Test]
  public void Writer_NullFile_ThrowsArgumentNullException() {
    Assert.That(() => ImageSysC64Writer.ToBytes(null!), Throws.TypeOf<ArgumentNullException>());
  }
}
