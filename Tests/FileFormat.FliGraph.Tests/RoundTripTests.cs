...
public sealed class RoundTripTests {
  ...
  public void WriteThenRead_PreservesData() {
    ...
    var bytes = FliGraphWriter.ToBytes(original);
    var roundTripped = FliGraphReader.FromBytes(bytes);
  ...
  public void Reader_NullBytes_ThrowsArgumentNullException() {
    Assert.That(() => FliGraphReader.FromBytes(null!), Throws.TypeOf<ArgumentNullException>());
  }

  [Test]
  public void Writer_NullFile_ThrowsArgumentNullException() {
    Assert.That(() => FliGraphWriter.ToBytes(null!), Throws.TypeOf<ArgumentNullException>());
  }
}
