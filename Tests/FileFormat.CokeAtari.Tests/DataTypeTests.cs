...
public sealed class DataTypeTests {
  ...
  [Test]
  [Category("Unit")]
  public void CokeAtariFile_DefaultPixelData_IsEmptyArray() {
  ...
  [Test]
  [Category("Unit")]
  public void CokeAtariFile_DefaultDimensions_AreZero() {
    var file = new CokeAtariFile();
  ...
  [Test]
  [Category("Unit")]
  public void CokeAtariFile_InitProperties_RoundTrip() {
  ...
  [Test]
  [Category("Unit")]
  public void CokeAtariFile_PrimaryExtension_IsTg1() {
    var ext = _GetStaticProperty<string>("PrimaryExtension");
    Assert.That(ext, Is.EqualTo(".tg1"));
  }

  [Test]
  [Category("Unit")]
  public void CokeAtariFile_FileExtensions_ContainsTg1() {
    var exts = _GetStaticProperty<string[]>("FileExtensions");
    Assert.That(exts, Has.Length.EqualTo(1));
    Assert.That(exts, Does.Contain(".tg1"));
  }

  [Test]
  [Category("Unit")]
  public void ToRawImage_Null_Throws() {
    Assert.Throws<ArgumentNullException>(() => CokeAtariFile.ToRawImage(null!));
  }
  ...
  public void ToRawImage_ReturnsRgb24() {
    ...
    var raw = CokeAtariFile.ToRawImage(file);
  ...
  public void FromRawImage_Null_Throws() {
    Assert.Throws<ArgumentNullException>(() => CokeAtariFile.FromRawImage(null!));
  }
  ...
  public void FromRawImage_WrongFormat_Throws() {
    ...
    Assert.Throws<ArgumentException>(() => CokeAtariFile.FromRawImage(raw));
  }
  ...
  private static T _GetStaticProperty<T>(string name) {
    var prop = typeof(CokeAtariFile).GetInterfaceMap(typeof(IImageFileFormat<CokeAtariFile>));
