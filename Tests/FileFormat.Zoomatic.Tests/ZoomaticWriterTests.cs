...
[TestFixture]
public sealed class ZoomaticWriterTests {

  [Test]
  [Category("Unit")]
  public void ToBytes_NullFile_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => ZoomaticWriter.ToBytes(null!));
  }
  ...
  public void ToBytes_ValidFile_OutputIs10003Bytes() {
    ...
    var bytes = ZoomaticWriter.ToBytes(file);
  ...
  private static ZoomaticFile _BuildValidFile() {
