...
[TestFixture]
public sealed class H264CabacHighProfileHashDiagnosticTests {
  [Test]
  public void ReportAllHighProfileIpbbHashes() {
    ...
    var encoded = Convert.FromBase64String((string)field!.GetRawConstantValue()!);
    ...
    foreach (var packet in H264VideoReader.Split(encoded))
