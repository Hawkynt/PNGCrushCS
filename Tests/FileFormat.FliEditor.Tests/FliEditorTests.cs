...
[TestFixture]
public sealed class FliEditorWriterTests {

  [Test]
  [Category("Unit")]
  public void ToBytes_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => FliEditorWriter.ToBytes(null!));
  }
  ...
  public void ToBytes_CorrectOutputSize() {
    ...
    var file = new FliEditorFile { LoadAddress = 0x3C00, RawData = rawData };
    var bytes = FliEditorWriter.ToBytes(file);
  ...
  public void ToBytes_LoadAddress_LittleEndian() {
    var file = new FliEditorFile { LoadAddress = 0xABCD, RawData = new byte[17000] };
    var bytes = FliEditorWriter.ToBytes(file);
...
[TestFixture]
public sealed class FliEditorDataTypeTests {

  [Test]
  [Category("Unit")]
  public void PrimaryExtension_IsFed() {
    Assert.That(_GetPrimaryExtension(), Is.EqualTo(".fed"));
  }

  [Test]
  [Category("Unit")]
  public void FileExtensions_ContainsFed() {
    var extensions = _GetFileExtensions();
    Assert.That(extensions, Does.Contain(".fed"));
  }

  [Test]
  [Category("Unit")]
  public void ToRawImage_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => FliEditorFile.ToRawImage(null!));
  }

  [Test]
  [Category("Unit")]
  public void FromRawImage_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => FliEditorFile.FromRawImage(null!));
  }
  ...
  public void FromRawImage_ThrowsNotSupportedException() {
    ...
    Assert.Throws<NotSupportedException>(() => FliEditorFile.FromRawImage(image));
  }

  [Test]
  [Category("Unit")]
  public void FixedWidth_Is160() {
    Assert.That(FliEditorFile.FixedWidth, Is.EqualTo(160));
  }

  [Test]
  [Category("Unit")]
  public void FixedHeight_Is200() {
    Assert.That(FliEditorFile.FixedHeight, Is.EqualTo(200));
  }
  ...
  public void ToRawImage_ProducesRgb24() {
    var data = TestHelpers._BuildValidFliEditorData(0x3C00);
    var file = FliEditorReader.FromBytes(data);
    var rawImage = FliEditorFile.ToRawImage(file);
  ...
  public void ScreenBankCount_Is8() {
    Assert.That(FliEditorFile.ScreenBankCount, Is.EqualTo(8));
  }

  [Test]
  [Category("Unit")]
  public void MinPayloadSize_IsBitmapPlus8ScreensPlusColor() {
    Assert.That(FliEditorFile.MinPayloadSize, Is.EqualTo(8000 + 8 * 1000 + 1000));
  }

  [Test]
  [Category("Unit")]
  public void DefaultRawData_IsEmpty() {
    var file = new FliEditorFile();
    Assert.That(file.RawData, Is.Empty);
  }

  private static string _GetPrimaryExtension() => _Helper<FliEditorFile>.PrimaryExtension;
  private static string[] _GetFileExtensions() => _Helper<FliEditorFile>.FileExtensions;
