...
[TestFixture]
public sealed class DinReaderTests {

  [Test]
  [Category("Unit")]
  public void FromBytes_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => DinReader.FromBytes(null!));
  }

  [Test]
  [Category("Unit")]
  public void FromFile_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => DinReader.FromFile(null!));
  }

  [Test]
  [Category("Unit")]
  public void FromFile_Missing_ThrowsFileNotFoundException() {
    var missing = new FileInfo(Path.Combine(Path.GetTempPath(), Guid.NewGuid() + ".din"));
    Assert.Throws<FileNotFoundException>(() => DinReader.FromFile(missing));
  }

  [Test]
  [Category("Unit")]
  public void FromStream_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => DinReader.FromStream(null!));
  }
  ...
  public void FromBytes_TooSmall_ThrowsInvalidDataException() {
    ...
    Assert.Throws<InvalidDataException>(() => DinReader.FromBytes(tooSmall));
  }
  ...
  public void FromBytes_ValidFile_ParsesLoadAddress() {
    ...
    var result = DinReader.FromBytes(data);
  ...
  public void FromStream_ValidFile_ParsesCorrectly() {
    ...
    var result = DinReader.FromStream(ms);
  ...
  public void FromBytes_MinPayloadOnly_BackgroundColorDefaultsToZero() {
    var data = new byte[DinFile.LoadAddressSize + DinFile.MinPayloadSize];
    var result = DinReader.FromBytes(data);
  ...
  private static byte[] _BuildValidFile(ushort loadAddress, byte backgroundColor) {
    ...
    var data = new byte[DinFile.LoadAddressSize + DinFile.MinPayloadSize + 1];
