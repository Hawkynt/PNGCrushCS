...
[TestFixture]
public sealed class DinWriterTests {

  [Test]
  [Category("Unit")]
  public void ToBytes_NullFile_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => DinWriter.ToBytes(null!));
  }
  ...
  public void ToBytes_ValidFile_OutputIs10003Bytes() {
    ...
    var bytes = DinWriter.ToBytes(file);
  ...
  private static DinFile _BuildValidFile() {
