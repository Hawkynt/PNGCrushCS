...
[TestFixture]
public sealed class MltWriterTests {

  [Test]
  [Category("Unit")]
  public void ToBytes_NullFile_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => MltWriter.ToBytes(null!));
  }
  ...
  public void ToBytes_ValidFile_OutputIs10003Bytes() {
    ...
    var bytes = MltWriter.ToBytes(file);
  ...
  private static MltFile _BuildValidFile() {
