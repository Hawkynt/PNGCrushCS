...
[TestFixture]
public sealed class MltReaderTests {

  [Test]
  [Category("Unit")]
  public void FromBytes_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => MltReader.FromBytes(null!));
  }

  [Test]
  [Category("Unit")]
  public void FromFile_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => MltReader.FromFile(null!));
  }

  [Test]
  [Category("Unit")]
  public void FromFile_Missing_ThrowsFileNotFoundException() {
    var missing = new FileInfo(Path.Combine(Path.GetTempPath(), Guid.NewGuid() + ".mlt"));
    Assert.Throws<FileNotFoundException>(() => MltReader.FromFile(missing));
  }

  [Test]
  [Category("Unit")]
  public void FromStream_Null_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => MltReader.FromStream(null!));
  }
  ...
  public void FromBytes_TooSmall_ThrowsInvalidDataException() {
    ...
    Assert.Throws<InvalidDataException>(() => MltReader.FromBytes(tooSmall));
  }
  ...
  public void FromBytes_ValidFile_ParsesLoadAddress() {
    ...
    var result = MltReader.FromBytes(data);
  ...
  public void FromStream_ValidFile_ParsesCorrectly() {
    ...
    var result = MltReader.FromStream(ms);
  ...
  public void FromBytes_WithTrailingData_ParsesTrailingBytes() {
    var data = new byte[MltFile.MinFileSize + 3];
    data[0] = 0x00;
    data[1] = 0x40;
  ...
  private static byte[] _BuildValidFile(ushort loadAddress, byte backgroundColor) {
    // LoadAddress(2) + Bitmap(8000) + Screen(1000) + Color(1000) + BackgroundColor(1) = 10003
    var data = new byte[MltFile.MinFileSize];
