...
[TestFixture]
public sealed class QuantumPaintWriterTests {

  [Test]
  [Category("Unit")]
  public void ToBytes_Null_ThrowsArgumentNullException()
    => Assert.Throws<ArgumentNullException>(() => QuantumPaintWriter.ToBytes(null!));

  [Test]
  [Category("Unit")]
  public void ToBytes_OutputIsExactly32032Bytes() {
    var file = _CreateMinimalFile();
    var bytes = QuantumPaintWriter.ToBytes(file);
  ...
  private static QuantumPaintFile _CreateMinimalFile() => new() {
    Palette = new short[16],
    PixelData = new byte[32000],
  };
}
