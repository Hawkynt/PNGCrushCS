...
[TestFixture]
public sealed class HinterGrundBildWriterTests {

  [Test]
  [Category("Unit")]
  public void ToBytes_NullFile_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => HinterGrundBildWriter.ToBytes(null!));
  }
  ...
  public void ToBytes_ValidFile_OutputIs10003Bytes() {
    ...
    var bytes = HinterGrundBildWriter.ToBytes(file);
  ...
  private static HinterGrundBildFile _BuildValidFile() {
