...
/// <summary>Assembles HighRes ST file bytes from an in-memory representation.</summary>
public static class HighResSTWriter {
  ...
  public static byte[] ToBytes(HighResSTFile file) {
